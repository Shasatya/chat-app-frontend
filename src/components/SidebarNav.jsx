import { MessageSquare, Users, UserPlus, Bell, User, MessageCircleCode } from "lucide-react";
...
export default function SidebarNav() {
  ...
  return (
    // <div className="w-20 bg-linear-to-b from-gray-900 via-gray-900 to-gray-950 flex flex-col items-center py-8 gap-2 z-20 border-r border-gray-800 shadow-2xl">
    ...
    //   <div className="w-10 h-px bg-gray-800 mb-2"></div>
    ...
    //     />
    //     {requests.length > 0 && (
    //       <span className="absolute -top-1 -right-1 w-5 h-5 bg-linear-to-br from-red-500 to-pink-500 rounded-full border-2 border-gray-900 flex items-center justify-center text-xs font-bold text-white shadow-lg">
    //         {requests.length}
    //       </span>
    //     )}
    //   </div>
